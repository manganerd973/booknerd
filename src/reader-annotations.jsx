...
export function AnnotatedParagraph({ text, runs = [], as: Element = 'p', className = '', style, listMarker, paragraphIndex, chapterId, annotations = [], footnotes = [], onOpenAnnotation, onOpenFootnote, onSelectionEnd }) {
