...
export default function AdvancedSearchPage({ books = [] }) {
  ...
  return (
    <div className="site-shell inner-site-shell advanced-search-page">
      ...
      <main>
        <section className="inner-hero"><span className="section-number">ПОИСК ПО БИБЛИОТЕКЕ</span><div><h1>Найдите<br /><em>свою историю.</em></h1><p>Ищите книгу по названию, автору, жанру, стране, переводчику, году или длине.</p></div></section>
