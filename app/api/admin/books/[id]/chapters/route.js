  ...
  try {
    ...
    await db.prepare(
      `INSERT INTO chapters
       (id, book_id, chapter_number, title, body, status, published_at, created_at, updated_at)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`
    ).bind(
      id, bookId, payload.chapterNumber, payload.title, payload.body, payload.status,
