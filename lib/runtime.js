  ...
  if (!schemaPromise) {
    schemaPromise = (async () => {
      ...
      await db.batch([
        ...
        db.prepare(`CREATE INDEX IF NOT EXISTS chapters_workflow_scheduled_idx ON chapters (workflow_status, scheduled_at)`),
        ...
        db.prepare(`CREATE INDEX IF NOT EXISTS reader_library_book_status_idx ON reader_library (book_id, status, visitor_key)`),
        ...
        db.prepare(`CREATE INDEX IF NOT EXISTS reader_notifications_visitor_unread_idx ON reader_notifications (visitor_key, read_at, hidden_at)`),
